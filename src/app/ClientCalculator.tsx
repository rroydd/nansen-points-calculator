...
export default function ClientCalculator(){
 const referralUrls:Record<string,string>={nansen:"https://nsn.ai/brelgin",predictfun:"https://predict.fun?ref=5D64A",dreamcash:"https://www.dreamcash.xyz/share?code=0PWE34",dyli:"https://www.dyli.io/?code=dr670541"};
 ...
 return <main style={style}>
  <nav><a className="brand" href={config.portalUrl}><span className="alpha">α</span><span>ALPHA TOOLS</span></a><div className="navlinks"><a href={config.docsUrl} target="_blank">Methodology ↗</a><a href={officialUrl} target="_blank">Open {config.name} ↗</a></div></nav>
